...
document.body.appendChild(Object(__WEBPACK_IMPORTED_MODULE_0__app_js__["a" /* appShell */])());
...
function appShell() {
  ...
  element.innerHTML += "<canvas name='game-canvas'></canvas>";
  return element;
}
