...
var App = exports.App = function () {
  ...
  _createClass(App, [{
    ...
    value: function bootstrap() {
      ...
      this.game = new _game.Game({ canvasId: this.canvasId });
      this.game.kickstart();
    }
  }, {
    key: 'shellAround',
    value: function shellAround(contents) {
      var html = new _html.Html();
...
var _graphics = __webpack_require__(333);
...
var Game = exports.Game = function () {
  function Game(opts) {
    ...
    this.graphics = new _graphics.Graphics(this.canvas);
  }
  ...
  _createClass(Game, [{
    ...
    value: function draw() {
      ...
      var grid = new _grid.Grid({ meshSize: 50 });
...
var Graphics = exports.Graphics = function () {
  ...
  _createClass(Graphics, [{
    ...
    value: function line(x0, y0, x1, y1) {
      ...
      this.context.beginPath();
      this.context.moveTo(0, 0);
      this.context.lineTo(w, h); //this.canvas.width, this.canvas.height);
      this.context.stroke();
      //this.ctx.endPath();
    }
  }, {
